...
private val LightColorScheme = lightColorScheme(
    ...
    onSecondaryContainer = Color.Gray400,
    tertiary = Color.Purple700,
    surface = Color.White,
    onSurface = Color.Black,
    inverseSurface = Color.Gray800,
    onSurfaceVariant = Color.Gray600,
    inverseOnSurface = Color.Gray200,
    outlineVariant = Color.Gray200,
...
private val DarkColorScheme = darkColorScheme(
    ...
    secondary = Color.Purple700,
    onSecondary = Color.White,
    onSecondaryContainer = Color.Gray600,
    tertiary = Color.Purple300,
    surface = Color.Black,
    onSurface = Color.White,
    inverseSurface = Color.Gray200,
    onSurfaceVariant = Color.Gray400,
    inverseOnSurface = Color.Gray800,
    outlineVariant = Color.Gray800,
    onError = Color.Yellow700,
)
